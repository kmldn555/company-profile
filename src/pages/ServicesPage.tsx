  ...
  return (
    <div className="bg-white">
      ...
      <div className="pt-15 md:pt-20 border border-black">
        ...
        {/* Billing Section */}
        <div className="bg-white">
          <div className="container h-full mx-auto justify-between items-center px-6 md:px-0 pb-12 pt-8 ">
                  ...
                  <div className="flex flex-col flex-1 p-6 gap-4">
                    <div>
                      ...
                      <div className="text-[15px] text-[#131B2E]">
                        Track workouts, activities, and performance metrics in
                        one simple platform.
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col flex-1 p-6 gap-4">
                    <div>
                      ...
                      <div className="text-[15px] text-white">
                        Custom technology solutions built for sports
                ...
                <Accordion className="w-full bg-white">
                  <AccordionItem value="FAQ-1">
                    ...
                    <AccordionContent className="text-[16px] text-justify">
                      Yes, absolute backward and forward database compatibility
                      is guaranteed. When upgrading from Track to Coach or
                      Insights, all athlete telemetry records, baseline fitness
                      assessments, and historical load files remain preserved
                      with zero loss of seasonal continuity.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                ...
                <Accordion className="w-full bg-white">
                  <AccordionItem value="FAQ-2">
                    ...
                    <AccordionContent className="text-[15px] text-justify">
                      VeloCore natively ingests ANT+ FE-C and Bluetooth Low
                      Energy standards. This covers Garmin, Wahoo, Polar, Whoop,
                      SRM, Favero Assioma, Stryd footpods, and VO2 Master
                      analyzers out of the box with zero third-party bridge
                      required.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                ...
                <Accordion className="w-full bg-white">
                  <AccordionItem value="FAQ-4">
                    ...
                    <AccordionContent className="text-[15px] text-justify">
                      ...
                      standards. Your biometric telemetry streams are encrypted
                      at rest with AES-256 and never monetized or exposed.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </div>
