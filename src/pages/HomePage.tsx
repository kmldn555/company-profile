      ...
      <div className="pt-15 md:pt-20">
        ...
        <div className="container h-full mx-auto justify-between items-center px-6 py-12 bg-[#F2F3FF]">
          <div className="flex items-center w-fit gap-2.5 px-3.5 py-1.5 rounded-full bg-white text-black shadow-sm">
            ...
            <div className="text-[11px] md:text-[16px]">SPORT TECHNOLOGY </div>
          </div>
              ...
              <div className="hidden md:flex md:justify-between bg-white mt-6 p-4 rounded-sm">
                <div className="grid grid-cols-1">
                  ...
                  <div className="flex gap-1 items-baseline">
                    ...
                    <div className="text-[#2563EB] text-[12px] font-bold">kHz</div>
                  </div>
                </div>
                <div className="grid grid-cols-1">
                  <div className="text-[11px] text-[#737686] font-bold">
                  ...
                  <div className="flex gap-1 items-baseline">
                    ...
                    <div className="text-[#2563EB] text-[12px] font-bold">AXIS</div>
                  </div>
                </div>
                <div className="grid grid-cols-1 ">
                  <div className="text-[11px] text-[#737686] font-bold">
                  ...
                  <div className="flex gap-1 items-baseline">
                    ...
                    <div className="text-[#2563EB] text-[12px] font-bold">ms</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* // Section 2*/}
        <div className="container h-full mx-auto justify-between items-center py-12 px-6 bg-[#F2F3FF]">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className=" grid md:grid-cols-4 gap-4">
              ...
              <div className="grid grid-cols-1 bg-[#F2F3FF] p-4 gap-2 rounded-sm">
                ...
                <div className="text-[15px]">
                  Custom technology solutions built for sports organizations and
                  businesses.
                </div>
                <div className="flex flex-row gap-2 text-[15px] items-center text-[#2563EB] font-semibold">
        ...
        {/* // Section 4*/}
        <div className="container h-full mx-auto justify-between items-center py-12 px-6 bg-[#283044]">
          <div className="grid md:grid-cols-2 gap-6 justify-center">
            ...
            <div className=" flex flex-col gap-2">
              ...
              <div className="text-[15px] md:text-[25px] text-[#DAE2FD]">
                VeloCore Insights transforms training and performance data into
                clear analytics that help athletes and coaches understand trends
            ...
            <div className=" grid bg-[#131B2E] p-4 gap-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-[#283044]/60">
                  ...
                  <div className="text-3 text-[#4CD7F6]">7-Day Trajectory</div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 bg-[#283044]/60">
                  ...
                  <div className="text-3 text-[#4CD7F6]">Ready for Session</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* // Section 5*/}
        <div className="container h-full mx-auto justify-between items-center py-12 px-6 bg-[#EAEDFF]">
          <div className="grid gap-6">
            {/* container 1 */}
            <div className="grid grid-cols-1 gap-1">
              <div className="text-[11px] md:text-[16px] text-[#00687A]">FIELD VALIDATION</div>
              <div className="text-[20px] md:text-[40px] font-semibold">
            ...
            <div className="grid md:grid-cols-3 gap-3">
              <div className="flex flex-col p-4 gap-4 rounded-xl shadow-sm/50 bg-white">
                ...
                <div className="italic text-justify text-[15px]">
                  ...
                  their training progress. The data is simple to understand and
                  easy to use."
                </div>
              ...
              <div className="flex flex-col p-4 gap-4 rounded-xl shadow-sm/50 bg-white">
                ...
                <div className="italic text-justify text-[15px]">
                  ...
                  programs. Our coaches can spend less time organizing data and
                  more time working with athletes."
                </div>
                <div className="flex flex-row gap-2 items-center">
                  <div className=" font-bold p-3 bg-[#00687A] rounded-full text-white tex-[14px]">
                    SW
              ...
              <div className="flex flex-col p-4 gap-4 rounded-xl shadow-sm/50 bg-white">
                ...
                <div className="italic text-justify text-[15px]">
                  "VeloCore Insights helps us turn large amounts of performance
        ...
        {/* // Section 6*/}
        <div className="container h-full mx-auto justify-between items-center pt-12 pb-12 px-6 bg-white">
          <div className="p-4 bg-[#283044] rounded-lg md:grid md:justify-items-center">
            <div>
              <div className="flex gap-1 items-center">
                ...
                <div className="text-[#ACEDFF] md:text-[16px] text-[12px]">START TODAY</div>
              </div>
