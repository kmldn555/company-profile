      ...
      <div className="pt-15 md:pt-20 ">
          ...
          <div className="container h-full mx-auto justify-between items-center px-6 py-12 ">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid-cols-2 gap-2 md:gap-4 mt-2 hidden md:grid rounded-sm">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-4 md:rounded-sm">
                ...
                <div className="flex flex-col bg-white shadow-sm/30 p-6 gap-2">
                  ...
                  <div className="text-[15px] text-[#434655]">
                    ...
                    pre-dawn marathon training sessions cutting through
                    Jakarta's humidity. A fellowship of software engineers,
                    sports data scientists, and competitive endurance athletes
                    encountered a shared barrier: consumer fitness monitors
                    delivered passive numbers, not actionable athletic
                    intelligence.
                  </div>
            ...
            <div className="flex-col flex gap-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-4 ">
                ...
                <div className="flex flex-col bg-white shadow-sm/30 p-6 gap-3 rounded-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="text-[#004AC6] text-[11px]">
                      OUR MISSION
                    </div>
                    <div className="text-[#131B2E] text-[20px]">
                      "To make sports performance more measurable, accessible,
                      and meaningful through technology and data."
                    </div>
                  </div>
              ...
              <div className="flex-col flex md:grid md:grid-cols-3 gap-4">
                ...
                <div className="grid p-4 gap-1 bg-[#004AC6] shadow-sm/30 rounded-lg">
                  <div className="flex justify-between">
                    ...
                    <div className="text-[12px] text-[#DBE1FF]">
                      NEXT GEN AI{" "}
                    </div>
                  </div>
                  ...
                  <div className="text-white">
                    ...
                    fatigue modeling directly into mobile telemetry
                    headsets.{" "}
                  </div>
                </div>
              </div>
          ...
          <div className="container h-full mx-auto justify-between items-center px-6 py-12 ">
            <div className="flex-col flex gap-6">
              <div className="flex flex-col gap-1 ">
                ...
                <div className="text-[15px] text-[#434655]">
                  The architectural principles shaping how we build algorithms
                  and treat athletes.
                </div>
              </div>
              {/* coantainer card */}
              <div className="flex-col flex gap-4 md:grid md:grid-cols-3">
                ...
                <div className="flex gap-4 bg-white shadow-sm/30 p-4">
                  ...
                  <div>
                    ...
                    <div className="text-[13px]">
                      Driven by tangible gains in speed, power, and endurance.
                      We celebrate metrics that directly correlate with winning
                      races.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4 bg-white shadow-sm/30 p-4">
                  ...
                  <div>
                    ...
                    <div className="text-[13px]">
                      Fostering high-performance sporting communities where
                      shared telemetry lifts the baseline for every squad
                      member.{" "}
                    </div>
                  </div>
                </div>
          ...
          <div className="container h-full mx-auto justify-between items-center px-6 py-12 ">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-1 ">
                ...
                <div className="text-[15px] text-[#434655]">
                  Cross-functional practitioners blending elite sports
                  physiology and modern computing.
                </div>
              </div>
              {/* container card */}
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="flex flex-col bg-[#FAF8FF] shadow-sm/30 gap-4 p-4">
                  ...
                  <div className="text-[13px] text-[#434655]">
                    ...
                    and reducing cognitive friction during high-intensity
                    training sessions.
                  </div>
                  <div className="flex gap-2">
                    <div className="px-2 py-0.5 text-[12px] text-[#434655]">
                ...
                <div className="flex flex-col bg-[#FAF8FF] shadow-sm/30 gap-4 p-4">
                  ...
                  <div className="text-[13px] text-[#434655]">
                    ...
                    oxygen kinetics, power cadence curves, and glycogen
                    depletion models.
                  </div>
                  <div className="flex gap-2">
                    <div className="px-2 py-0.5 text-[12px] text-[#434655]">
                ...
                <div className="flex flex-col bg-[#FAF8FF] shadow-sm/30 gap-4 p-4">
                  ...
                  <div className="text-[13px] text-[#434655]">
                    Applied ML researcher specializing in predictive training
                    load algorithms and non-invasive injury probability
                    modeling.
                  </div>
                  <div className="flex gap-2">
                    <div className="px-2 py-0.5 text-[12px] text-[#434655]">
        ...
        <div className="bg-[#FAF8FF]">
          <div className="container h-full mx-auto justify-between items-center px-6 py-12 ">
            {/* container text */}
            <div className="flex flex-col gap-2">
              <div className="text-[#004AC6] text-[11px] md:text-[16px]">
                OPERATING SYSTEM
              </div>
            ...
            <div className="flex flex-col md:grid-cols-4 md:grid gap-4 mt-4">
              ...
              <div className="flex flex-col p-4 gap-1 bg-white shadow-sm/30 rounded-lg">
                ...
                <div className=" text-[#434655] text-[13px]">
                  Zero silos. Cross-pollination between code commits and
                  marathon splits is our default state.
                </div>
              </div>
              {/* card 2 */}
              <div className="flex flex-col p-4 gap-1 bg-white shadow-sm/30 rounded-lg">
              ...
              <div className="flex flex-col p-4 gap-1 bg-white shadow-sm/30 rounded-lg">
                ...
                <div className=" text-[#434655] text-[13px]">
                  Every pipeline we deploy must measurably push an athlete
                  forward on the track or trail.
                </div>
              </div>
            </div>
          </div>
