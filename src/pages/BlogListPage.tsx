  ...
  return (
    <div className="bg-white">
      ...
      <div className="pt-15 md:pt-20 ">
        {/* Header Section */}
        <div className="container h-full mx-auto justify-between items-center px-6 pt-12 pb-4 bg-[#F2F3FF] ">
        ...
        <div className="container h-full mx-auto justify-between items-center px-6 pt-1 pb-1 bg-[#F2F3FF]">
          <div className="flex bg-white  rounded-sm shadow-sm/30">
            <Input placeholder="Search by title or category..." className="h-10"/>
            <img src="IconSearch.svg" alt="IconSearch" className="p-2" />
          </div>
        </div>
        {/* Blog Section */}
        <div className="container h-full mx-auto justify-between items-center px-6 pb-12 pt-4 bg-[#F2F3FF]">
          {isLoading ? (
