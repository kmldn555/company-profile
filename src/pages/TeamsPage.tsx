    ...
    <div className="bg-white">
      ...
      <div className="pt-15 md:pt-20 border-2 border-white">
        ...
        <div className="bg-[#F2F3FF]">
          <div className="container h-full mx-auto justify-between items-center px-6 pt-9 pb-6  ">
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="flex flex-col py-5 px-3 bg-white rounded-sm">
                  ...
                  <div className="text-[32px] text-[#131B2E] font-bold">
                    100%
                  </div>
                </div>
              </div>
        ...
        {/* Search Toolbar */}
        <div className="bg-[#F2F3FF]">
          <div className="container h-full mx-auto justify-between items-center px-6 pt-3 pb-1  ">
        ...
        {/* Team Member */}
        <div className="bg-[#F2F3FF]">
          <div className="container h-full mx-auto justify-between items-center px-6 py-4 ">
            {/* container card */}
            <div className="flex flex-col md:grid md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col bg-[#FAF8FF] shadow-sm/30 gap-4 p-4">
                ...
                <div className="p-3 bg-[#F2F3FF] rounded-sm">
                  ...
                  <div className="text-[13px] text-[#434655]">
                    Develops responsive and interactive interfaces for
                    VeloCore's web applications.
                  </div>
                </div>
                <div className="flex gap-2">
                  <div className="flex gap-1 items-center">
